...
export class SOVPLElemInstance {
    ...
    onSORegister(props) {
        ...
        props.foreach(prop => {
            ...
            this.elemData.editorData.details.mapPropsProgrammingActive[prop.name] = true;
        });
    ...
    onSOEditPropProgrammingActive(prop) {
        this.elemData.editorData.details.mapPropsProgrammingActive[prop.name] = prop.active;
