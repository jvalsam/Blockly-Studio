...
import { MenuGroupViewItem } from "../../../../../src/app/ide/components-framework/common.components/shell/menu/menu-view/menu-view-group-item";
...
export class ComponentsBridge {
	public static initialize(): void {
		ApplicationWSPEditorView.onInit();
