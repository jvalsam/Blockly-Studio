...
export class ProjectCategoryView extends ProjectManagerElementView {
    ...
    private addCategory (category): void {
        ...
        let categView = <ProjectCategoryView>ViewRegistry.getEntry("ProjectManagerCategoryView").create(
            this.parent,
            this.elemsSel,
            {
                "parentTree": this,
