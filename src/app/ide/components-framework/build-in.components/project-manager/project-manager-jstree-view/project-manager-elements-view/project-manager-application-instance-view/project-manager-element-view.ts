...
import { ProjectInstanceView } from "./project-instance-view";
...
export abstract class ProjectManagerElementView extends View {
    ...
    constructor(
        ...
        protected parentTree: ProjectManagerElementView | ProjectInstanceView,
    ...
    public removeElement(systemID: string): boolean {
        if (this._systemID === systemID) {
            ...
            if(this.parentTree["_children"]) {
                ...
                _.remove(
                    (<ProjectInstanceView>this.parentTree)["categories"],
